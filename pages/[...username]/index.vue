  ...
  <NuxtLayout name="user-page">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700 max-h-[80vh]">
          ...
          <div class="p-6 pt-3 space-y-3 w-full max-h-[calc(100%-10rem)]">
            <div
              ...
              <div v-html="data.selectedPost.content.content" class="mx-auto text-gray-900 dark:text-gray-50" :class="
    ...
    <div class="flex flex-col mt-10 gap-y-8 w-full">
      <ul v-if="pending || data.status !== 200"
        class="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2 max-h-full">
