  ...
  <div class="flex flex-col justify-center mt-10">
    <div class="flex flex-col sm:flex-row gap-5 sm:gap-10 lg:gap-20 mx-auto">
      <div class="flex flex-col w-40 mx-auto">
        <img v-if="userData.data.profilepic != null" class="w-40 h-40 mb-3 rounded-full shadow-lg mx-auto sm:mx-0"
          :src="userData.data.profilepic" alt="user image" />
      ...
      <div class="flex flex-col gap-y-2 my-auto w-[60vw]">
        <div class="flex flex-row sm:gap-y-4 justify-between">
          ...
          <div class="flex flex-row gap-4 items-center justify-between align-middle">
            <div v-if="!userData.data.isCurrentUser()">
              <button data-modal-target="popup-modal" data-modal-toggle="popup-modal" v-if="followingData.isFollowing"
                type="button"
        ...
        <div class="flex flex-col sm:flex-row sm:gap-8">
          ...
          <li>
            <button type="button" data-modal-target="followers-modal" data-modal-toggle="followers-modal"
              class="font-regular">
          ...
          <li>
            <button type="button" data-modal-target="following-modal" data-modal-toggle="following-modal"
              class="font-regular">
