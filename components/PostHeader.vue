<template>
  <div class="flex flex-row justify-between align-middle">
    <div class="flex flex-row gap-3">
      <UserCircleIcon v-if="profilePictureUrl === undefined || profilePictureUrl === null || profilePictureUrl === ''"
        class="h-10 w-10 my-auto text-gray-300 dark:text-gray-600" />
    ...
    <div>
      <button id="actions-trigger" name="post-actions" @click="openPopoverMenu()" type="button">
