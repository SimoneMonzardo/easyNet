<template>
  <div
    class="max-w p-8 sm:flex sm:space-x-6 dark:bg-gray-900 dark:text-gray-100 place-content-center"
  >
    <div class="flex flex-col space-y-4" style="margin-right: 40%">
      <div style="display: flex">
        ...
        />
        <div>
          <h2 class="text-3xl font-semibold" style="margin-left: 50px">
            {{ user_name }}
          </h2>
          <div style="display: flex; margin-top: 4%">
            <h2
              class="text-xl font-semibold"
              style="margin-left: 50px; margin-top: 1%"
            >
